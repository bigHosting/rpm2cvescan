...
install -m 0700 rpmvercmp.el5 $RPM_BUILD_ROOT/usr/local/bin/rpmvercmp.el5
...
%attr(0700,root,root) /usr/local/bin/rpmvercmp.el5
...
%changelog
* Mon Jul 17 2017 SecurityGuy <securityteam@fakedomain.com> -3
- Compiled rmpvercmp on el5
